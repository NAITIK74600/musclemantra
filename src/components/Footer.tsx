  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-[rgba(255,255,255,0.06)]">
      <div className="container-max py-10 sm:py-12">
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-white/6 flex flex-col-reverse sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-2.5">
            <a
              ...
              className="w-10 h-10 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center text-white/60 hover:bg-[#FF6B00] hover:border-[#FF6B00] hover:text-white transition-all"
            >
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="WhatsApp"
              className="w-10 h-10 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center text-white/60 hover:bg-[#25D366] hover:border-[#25D366] hover:text-white transition-all"
            >
              <svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" aria-hidden="true">
