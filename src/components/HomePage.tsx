...
/** Consistent reveal-on-scroll wrapper (opacity + translate only — GPU cheap) */
...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: '74vh' }}>
      ...
      <div className="container-max relative z-10 py-16 lg:py-24">
        <div style={{ minHeight: '54vh' }} className="flex items-center">
          <div className="w-full lg:max-w-[52%]">
            ...
            <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
              ...
              <span className="text-[11px] font-semibold text-white/90 tracking-wide">100% Authentic · Patna&apos;s Supplement Store</span>
            </motion.div>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 }}
              ...
              Genuine whey, creatine, pre-workout &amp; more from the brands you trust — delivered to your door in 30 minutes.
            </motion.p>
...
/* ──────────────────────────────────────────────────────────
   TRUST STRIP  (social proof — placed directly under hero)
   ────────────────────────────────────────────────────────── */
function TrustStrip() {
  const items = [
    ...
    { icon: HeadphonesIcon, title: 'Expert Support', sub: '24×7 nutrition guidance' },
  ];
  return (
...
function TopBrandsSection() {
  ...
  return (
    <section className="py-16 md:py-20 bg-[#050505] border-y border-[rgba(255,255,255,0.06)]">
      <div className="container-max">
        <Reveal>
...
function WhyChooseUs() {
  const points = [
    ...
    { icon: Truck, title: 'Lightning-Fast Delivery', desc: 'Get your supplements delivered across Patna in as little as 30 minutes — no long waits.' },
